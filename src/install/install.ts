 ...
 * output directory.
 */
async function _install(offline: boolean, bowerJson?: JsonObject, componentDirectory?: string, variantName?: string): Promise<void> {
...
async function installVariants(offline: boolean): Promise<void> {
  ...
  // installed into folders named "bower_components-{variantName}", which are
