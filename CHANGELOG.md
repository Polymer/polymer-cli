...
- **Updated `lint` Command**: `polymer lint` is now powered by our newest version of [polymer-linter](https://github.com/Polymer/polymer-linter), which provides even more control over different lint rules. Run `polymer help lint` for more information.
